...
│   │   │   ├── resource_edgenext_cdn_domain_config.go # Domain config resource
...
|----------|-------------|
| `edgenext_cdn_domain_config` | Manage CDN domain configuration |
...
|-------------|-------------|
| `edgenext_cdn_domain_config` | Query CDN domain configuration |
