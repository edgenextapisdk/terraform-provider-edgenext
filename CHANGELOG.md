...
### Resources
- `edgenext_cdn_domain_config`: Complete CDN domain and configuration management
...
### Data Sources
- `data.edgenext_cdn_domain_config`: Query domain configurations
- `data.edgenext_cdn_domain_configs`: Query multiple domain configurations
