...
func getResourceDesc(resourceName string) string {
	descriptions := map[string]string{
		...
		// ECS resources
		"edgenext_ecs_key_pair":            "ECS key pairs",
		"edgenext_ecs_vpc":                 "ECS VPC networks",
		"edgenext_ecs_vpc_subnet":          "ECS VPC subnets",
		...
		"edgenext_ecs_resource_tag":        "ECS resource tag bindings",
		// SCDN resources
...
func getDataSourceDesc(dataSourceName string) string {
	descriptions := map[string]string{
		...
		// ECS data sources
		"edgenext_ecs_instances":            "ECS instances",
		"edgenext_ecs_images":               "ECS images",
		"edgenext_ecs_key_pairs":            "ECS key pairs",
		"edgenext_ecs_vpcs":                 "ECS VPC networks",
		"edgenext_ecs_external_gateways":    "ECS external gateways",
		...
		"edgenext_ecs_resource_tags":        "ECS resource tag relations",
		// SCDN data sources
