...
* `type` - (Required, String, ForceNew) URL type for purge: dir(directory), url(URL)
* `urls` - (Required, List: [`String`], ForceNew) List of URLs/directories to purge, maximum 500 URLs per request
